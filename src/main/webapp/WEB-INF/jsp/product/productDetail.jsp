...
<html>
	...
	<body>
		...
		<%
			...
			if (cartMessage != null) {
		%>
				<p id="cart-msg" style="color: green; font-weight: bold; margin-left: 5%;"><%= cartMessage %></p>
		<%
		...
		%>
				<p id="fav-msg" style="color: green; font-weight: bold;  margin-left: 5%;"><%= favoriteMessage %></p>
		<%
		...
		<div class="product-detail-container">
			...
			<div class="product-detail-wrapper">
				...
				<p class="product-price">￥<%= nf.format(product.getPrice()) %>(税込)</p>
				<form action="${pageContext.request.contextPath}/cart/add" method="post">
					<input type="hidden" name="productId" value="<%= product.getProductId() %>">
					<input type="hidden" name="fromPage" value="detail">
					<button type="submit" class="cart-add-btn black-btn">
						カートに追加する
					</button>
				</form>
