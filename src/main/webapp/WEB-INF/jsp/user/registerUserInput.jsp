			...
			<form action="${pageContext.request.contextPath}/register/user/confirm" method="post">
				<div class="sei-and-mei">
					<div class="form-group">
						<label>姓</label>
						<input type="text" name="sei" size="35" placeholder="姓" value="<%= inputUser != null ? inputUser.getSei() : "" %>">
					</div>
					
					<div class="form-group">
						<label>名</label>
						<input type="text" name="mei" size="35" placeholder="名" value="<%= inputUser != null ? inputUser.getMei() : "" %>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<input type="date" name="birthday" 
						value="<%= inputUser != null ? inputUser.getBirthday() : "" %>">
				</div>
				...
				<div class="postalCode-and-prefecture">
					<div class="form-group">
						<label>郵便番号</label>
						<input type="text" name="postalCode" placeholder="例：1011001" value="<%= inputUser != null ? inputUser.getPostalCode() : "" %>">
					</div>
					<div class="form-group">
						<label>都道府県</label>
				...
				<div class="form-group">
					<label>住所</label>
					<input type="text" name="address" size="70" placeholder="市区町村・番地を入力" value="<%= inputUser != null ? inputUser.getAddress() : "" %>">
				</div>
				...
				<div class="form-group">
					<label>電話番号</label>
					<input type="text" name="phoneNumber" placeholder="例：09012345678" value="<%= inputUser != null ? inputUser.getPhoneNumber() : "" %>">
				</div>
				
				<div class="form-group">
					<label>メールアドレス</label>
					<input type="mail" name="mail" placeholder="メールアドレス" value="<%= inputUser != null ? inputUser.getMail() : "" %>">
				</div>
				
				<div class="form-group">
					<label>パスワード</label>
					<input type="text" name="password" placeholder="パスワード（半角英数字・記号のみ8~100文字">
				</div>
