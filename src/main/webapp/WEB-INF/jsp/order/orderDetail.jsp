<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="model.entity.Order, java.util.List, model.entity.OrderItem, java.time.format.DateTimeFormatter, java.text.NumberFormat" %>
<%
...
<html>
	...
	<body>
		...
		<div class="order-detail-wrapper">
			...
			<p>
				<span>ご注文日時：<%= orderItem.getCreateDate().format(formatter) %></span><br>
				<span>商品名：<%= orderItem.getProduct().getProductName() %></span><br>
				<span>商品番号：<%= orderItem.getProduct().getProductId() %></span><br>
				<span>商品代金：￥<%= nf.format(orderItem.getProduct().getPrice()) %></span><br>
				<span>個数：<%= orderItem.getQuantity() %></span><br>
				<span>支払方法：
							<%
				...
				<span id="canceled" style="color:red">キャンセル済み</span>
				<% } %>
			</p>
		</div>
		<hr>
