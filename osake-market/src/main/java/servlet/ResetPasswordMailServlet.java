...
import model.ResetPasswordMailLogic;
...
public class ResetPasswordMailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/resetPasswordBeforeMail.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (isValid) { // メール送信成功時
			// フォワード
			RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/resetPasswordAfterMail.jsp");
			dispatcher.forward(request, response);
		} else { // メール送信失敗時
