...
<html>
	...
	<body>
		...
		<%
			...
			if (msg != null) {
		%>
				<p id="update-done-msg" style="color: green; font-weight: bold; margin-left: 5%;"><%= msg %></p>
		<%
			...
			<form action="${pageContext.request.contextPath}/update/user/done" method="post">
				<div class="sei-and-mei">
					<div class="form-group">
						<label>姓</label>
						<input type="text" name="sei" size="35" value="<%= user.getSei() %>" required>
					</div>
					<div class="form-group">
						<label>名</label>
						<input type="text" name="mei" size="35" value="<%= user.getMei() %>" required>
					</div>
				</div>
				<div class="form-group">
					<label>生年月日</label>
					<input type="date" name="birthday" value="<%= user.getBirthday() %>" required>
				</div>
				<div class="form-group">
					<label>性別</label>
				...
				<div class="postalCode-and-prefecture">
					<div class="form-group">
						<label>郵便番号</label>
						<input type="text" name="postalCode" value="<%= user.getPostalCode() %>" required>
					</div>
					<div class="form-group">
						<label>都道府県</label>
				...
				<div class="form-group">
					<label>住所</label>
					<input type="text" name="address" size="70" value="<%= user.getAddress() %>" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>メールアドレス</label>
					<input type="mail" name="mail" value="<%= user.getMail() %>" required>
				</div>
				<div class="form-group">
					<label>パスワード</label>
